...
# NOTE: unfinished experiment — exits after the reverse-sampling debug loop below; the
# interpolation code after exit(0) references variables that are never defined
def main():
    n_frames = 48
    timesteps = 100
    t_start = 0.5
