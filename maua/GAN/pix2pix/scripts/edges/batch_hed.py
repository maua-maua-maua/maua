...
def parse_args():
    ...
    parser.add_argument(
        "--caffemodel", dest="caffemodel", help="caffemodel", default="./hed_pretrained_bsds.caffemodel", type=str
    )
    parser.add_argument(
        "--prototxt", dest="prototxt", help="caffe prototxt file", default="./deploy.prototxt", type=str
    )
    parser.add_argument("--images_dir", dest="images_dir", help="directory to store input photos", type=str)
    parser.add_argument(
        "--hed_mat_dir", dest="hed_mat_dir", help="directory to store output hed edges in mat file", type=str
    )
